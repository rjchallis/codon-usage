...
row.append('rect').attr('class','cu-control-rect active').attr('rel','Scaffolds').attr('width','320px').attr('height','28px')
...
row.append('rect').attr('class','cu-control-rect').attr('rel','Genes').attr('width','320px').attr('height','28px')
var a = row.append('g').attr('transform','translate(0,0)')
...
row.append('rect').attr('class','cu-control-rect').attr('rel','Transcripts').attr('width','320px').attr('height','28px')
var a = row.append('g').attr('transform','translate(0,0)')
...
row.append('rect').attr('class','cu-control-rect').attr('rel','CDS').attr('width','320px').attr('height','28px')
var a = row.append('g').attr('transform','translate(0,0)')
...
row.append('rect').attr('class','cu-control-rect').attr('rel','Exons').attr('width','320px').attr('height','28px')
var a = row.append('g').attr('transform','translate(0,0)')
